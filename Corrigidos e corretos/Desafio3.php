<?php
    ...
    function calculo($nota1, $nota2, $nota3, $numeroDeNotas, $aulasFrequentadas, $aulas, $nome) {
        // Fazendo cálculo da nota
        $notaFinal = ($nota1 + $nota2 + $nota3) / $numeroDeNotas;
        $notaArredondada = round($notaFinal, 0);

        // Fazendo cálculo da frequência
    ...
    echo calculo($nota1, $nota2, $nota3, $numeroDeNotas, $aulasFrequentadas, $aulas, $nome);
?>